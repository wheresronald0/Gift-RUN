...
const charities = () => {
  return (
    <div className="aboutUs">
      <div>
        <p>
          <strong>Gift-RUN - where your miles go a long way!</strong> <br />{" "}
          <br />
          ...
          <br /> <br />
          Each hard fought mile can be converted to a one dollar contribution to
        ...
        <div className="card">
          <div className="content">
            ...
            <p className="charityDescription">
              SPCA International works to stop the abuse and suffering of
              animals with innovative programs that serve both animals and their
              human caretakers.
            </p>
        ...
        <div className="card">
          <div className="content">
            ...
            <p className="charityDescription">
              ...
              research, patient services, early detection, treatment and
              education at cancer.org.
            </p>
        ...
        <div className="card">
          <div className="content">
            ...
            <p className="charityDescription">
              ...
              whatever it takes to save children, transforming their lives and
              the future we share.
            </p>
            <a href="https://www.cancer.org/">
              <button class="ui yellow button">
        ...
        <div className="card">
          <div className="content">
            ...
            <p className="charityDescription">
              ...
              in your community and around the world build or improve a place
              they can call home.
            </p>
